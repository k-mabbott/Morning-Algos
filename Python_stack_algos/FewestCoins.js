...
console.log(fewestCoinChange1(cents1)) // { quarter: 1 }
console.log(fewestCoinChange1(cents2)) // { quarter: 2 }
console.log(fewestCoinChange1(cents3)) // { nickel: 1, penny: 4 }
console.log(fewestCoinChange1(cents4)) // { quarter: 3, dime: 2, penny: 4 }